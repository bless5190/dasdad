...
{/* Seção Sobre */}
<motion.section id="sobre" className="py-20 px-6 text-center text-white bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/confiança.jpeg')", backgroundPosition: 'center bottom', backgroundSize: '110%', filter: 'brightness(0.8) opacity(0.7)' }} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
